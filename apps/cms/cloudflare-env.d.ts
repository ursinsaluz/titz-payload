/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 99d8097136d8e2c2c74a8f8508c679e3)
// Runtime types generated with workerd@1.20260828.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	D1: D1Database;
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	PAYLOAD_MCP_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_MCP_TOKEN" | "WEB_DEPLOY_HOOK_URL">> {}
}
